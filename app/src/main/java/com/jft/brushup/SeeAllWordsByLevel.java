...
public class SeeAllWordsByLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_see_all_words_by_level);

        DdBb myddbb = new DdBb(this);
        final List<Word> fullwords=myddbb.getAllWordsByLevel();
        ...
        for(int i = 0; i < fullwords.size(); ++i) {
            words.add("    "+Integer.toString(fullwords.get(i).getCategory())+". "+fullwords.get(i).getWord()+": "+fullwords.get(i).getMeaning());
        }
        ...
        Button button2 = findViewById(R.id.button_orderedByWord);
